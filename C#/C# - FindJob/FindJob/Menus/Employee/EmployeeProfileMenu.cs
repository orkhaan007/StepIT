...
namespace Menus
{
    ...
    {
        public static void showEmployeeProfileMenu(Employee employee)
        {
            Console.CursorVisible = false;
            int selectedOption = 0;
            string[] options = { "Show Profile", "Edit Profile", "Create CV", "Show CV", "Edit CV", "Log Out", "Back" };
            while (true)
            {
                Console.Clear();
                ...
                switch (keyInfo.Key)
                {
                    ...
                    case ConsoleKey.Enter:
                        ...
                        if (selectedOption == 1)
                        {
                            ...
                            employee.EditProfile(name,surname,age,city,phone,email);
                        }
                        if (selectedOption == 2)
                            employee.CreateCV();
                        if (selectedOption == 3)
                        ...
                        {
                            Console.Clear();
                            string name, surname, profession, experince;
                            ...
                            Console.WriteLine("Enter Experince: ");
                            experince = Console.ReadLine();
                            employee.cvs[0].EditCV(name,surname,profession,experince,skills);
                        }
                        if (selectedOption == 5)
                        {
